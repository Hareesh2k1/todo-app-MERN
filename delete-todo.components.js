...
export default class CreateTodo extends Component {    constructor(props) {
        ...
        console.log(`Todo Responsible: ${this.state.todo_date}`);
                ...
                <form onSubmit={this.onSubmit}>
                    <div className="form-group">
                        ...
                        <input
                                ...
                                onChange={this.onChangeTodoResponsible} placeholder="Summary"
                                />
                    </div>
                    ...
                    <div className="form-group">
                        ...
                        <textarea rows="4" className="form-control" value={this.state.todo_description} onChange={this.onChangeTodoDescription} cols="50" placeholder="Description" >
                        </textarea>        
                    </div>
                    <div className="form-group">
